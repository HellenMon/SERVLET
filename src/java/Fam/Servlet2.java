                ...
                if(edad1>edad3){
                    if(edad1>edad4){
                        if (edad1>edad5){
                            ...
                            out.println("<li><h2>Mi hermana es "+par3+" y tiene "+edad3+" años"+"</h2></li>");
                            out.println("<li><h2>Mi primo es "+par4+" y tiene "+edad4+" años"+"</h2></li>");
                ...
                if(edad5<edad3)
                    if (edad5<edad2)
                        if (edad5<edad1){
                            out.println("<ul>");
                            out.println("<li><h2>Yo soy "+par5+" y tengo "+edad5+" años"+"</h2></li>");
                            out.println("<li><h2>Mi primo "+par4+" y tiene "+edad4+" años"+"</h2></li>");
                            out.println("<li><h2>Mi hermana  es "+par3+" y tiene "+edad3+" años"+"</h2></li>");
                            out.println("<li><h2>Mi mamá es "+par2+" y tiene "+edad2+" años"+"</h2></li>");
                            out.println("<li><h2>Mi papá es "+par1+" y tiene "+edad1+" años"+"</h2></li>");
                            out.println("</ul>");
